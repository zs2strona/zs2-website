    ...
    <>
      ...
      <main className={`container ${inter.className}`}>
        ...
        <div className="main-container">
          <Image src="/Placeholder.png" alt="image" width="250" height="450"></Image>
          <Image src="/Placeholder.png" alt="image" width="250" height="450"></Image>
          <Image src="/Placeholder.png" alt="image" width="250" height="450"></Image>
          <Image src="/Placeholder.png" alt="image" width="250" height="450"></Image>
          <Image src="/Placeholder.png" alt="image" width="250" height="450"></Image>
        ...
        <div className="main-discounts">
          ...
          <h2>
            RABATY PRZYSŁUGUJĄ ZARÓWNO UCZNIOM SZKOŁY JAK I NAUCZYCIELOMI PRACOWNIKOM.
          </h2>
          <h2>
            ABY SKORZYSTAĆ ZE ZNIŻKI NALEŻY OKAZAĆ WAŻNĄ LEGITYMACJĘ UCZNIOWSKĄ - W
            PRZYPADKU UCZNIÓW. A W PRZYPADKU NAUCZYCIELI I PRACOWNIKÓW NALEŻY OKAZAĆ KARTĘ
            RABATOWĄ.
          </h2>
          <Link href="/znizki">
        ...
        <div className="main-footer">
          ...
          <h4>
            - współpracować, pomagać lub inicjować imprezy okolicznościowe z okazji
            Andrzejek, walentynek, Dnia Kobiet, mikołajek itp.
          </h4>
          <h4>
            - współpracować z instytucjami pozarządowymi oraz okolicznymi firmami w celu
            pozyskiwania środków finansowych na cele i przedsięwzięcia szkolne.
          </h4>
